...
export default function Page() {
  const [state, setState] = useState<SettingsPanelState>(DEFAULT_SETTINGSPANEL_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Settings Panel Studio" controls={controls} preview={output} /></AppShell>;
}
